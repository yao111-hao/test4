...
`elsif __au50__
  input      [NUM_CMAC_PORT-1:0] hbm_clk_clk_n,
  input      [NUM_CMAC_PORT-1:0] hbm_clk_clk_p,
  output                         hbm_cattrip,
`endif
...
`endif
  ...
  // 在例化之前，定义用于AXI Tie-off的信号
  logic m_axi_dev_mem_awready_tieoff;
  logic m_axi_dev_mem_wready_tieoff;
  logic m_axi_dev_mem_arready_tieoff;
  logic [1:0] m_axi_dev_mem_bresp_tieoff;
  logic m_axi_dev_mem_bvalid_tieoff;
  logic [1:0] m_axi_dev_mem_rresp_tieoff;
  logic m_axi_dev_mem_rvalid_tieoff;
...
// );
  ...
  design_1 axi3to1_smartconnect_to_dev_mem_inst (
  // --- System Clocks and Resets ---
  .axis_aclk(axis_aclk),
  .axis_arestn(qdma_rstn),
  .pcie_rstn(pcie_rstn_int),

  // --- HBM Physical Interface ---
  .hbm_clk_clk_n(hbm_clk_clk_n),
  .hbm_clk_clk_p(hbm_clk_clk_p),

  // --- Slave AXI Interface 0 (连接到 QDMA Master) s_axi_qdma_mm_---
  .s_axi_qdma_mm_araddr(axi_qdma_mm_araddr),
  .s_axi_qdma_mm_arburst(axi_qdma_mm_arburst),
  .s_axi_qdma_mm_arcache(axi_qdma_mm_arcache),
  .s_axi_qdma_mm_arid({1'd0,axi_qdma_mm_arid}),
  ...
  // --- Slave AXI Interface 1 (连接到 Compute Logic Master)s_axi_compute_logic_ ---
  .s_axi_compute_logic_araddr(axi_compute_logic_araddr),
  .s_axi_compute_logic_arburst(axi_compute_logic_arburst),
  .s_axi_compute_logic_arcache(axi_compute_logic_arcache),
  .s_axi_compute_logic_arid(axi_compute_logic_arid),
  ...
  // --- Slave AXI Interface 2 (连接到 System Crossbar Master) s_axi_from_sys_crossbar_ ---
  .s_axi_from_sys_crossbar_araddr(axi_from_sys_to_dev_crossbar_araddr),
  .s_axi_from_sys_crossbar_arburst(axi_from_sys_to_dev_crossbar_arburst),
  .s_axi_from_sys_crossbar_arcache(axi_from_sys_to_dev_crossbar_arcache),
  .s_axi_from_sys_crossbar_arid({2'd0,axi_from_sys_to_dev_crossbar_arid}),
